...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.Check();
  });
  ...
  describe('Check', function() {
    it('should create an instance of Check', function() {
      ...
      //var instane = new PlastiqPublicApi.Check();
      //expect(instance).to.be.a(PlastiqPublicApi.Check);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new PlastiqPublicApi.Check();
