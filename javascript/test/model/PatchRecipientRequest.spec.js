...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.PatchRecipientRequest();
  });
  ...
  describe('PatchRecipientRequest', function() {
    it('should create an instance of PatchRecipientRequest', function() {
      // uncomment below and update the code to test PatchRecipientRequest
      //var instane = new PlastiqPublicApi.PatchRecipientRequest();
      //expect(instance).to.be.a(PlastiqPublicApi.PatchRecipientRequest);
    });
    ...
    it('should have the property businessName (base name: "businessName")', function() {
      ...
      //var instance = new PlastiqPublicApi.PatchRecipientRequest();
