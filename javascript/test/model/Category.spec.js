...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.Category();
  });
  ...
  describe('Category', function() {
    it('should create an instance of Category', function() {
      ...
      //var instane = new PlastiqPublicApi.Category();
      //expect(instance).to.be.a(PlastiqPublicApi.Category);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new PlastiqPublicApi.Category();
