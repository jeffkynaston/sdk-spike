...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.RecipientAddress();
  });
  ...
  describe('RecipientAddress', function() {
    it('should create an instance of RecipientAddress', function() {
      ...
      //var instane = new PlastiqPublicApi.RecipientAddress();
      //expect(instance).to.be.a(PlastiqPublicApi.RecipientAddress);
    });

    it('should have the property line1 (base name: "line1")', function() {
      // uncomment below and update the code to test the property line1
      //var instance = new PlastiqPublicApi.RecipientAddress();
