...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.PatchCard();
  });
  ...
  describe('PatchCard', function() {
    it('should create an instance of PatchCard', function() {
      // uncomment below and update the code to test PatchCard
      //var instane = new PlastiqPublicApi.PatchCard();
      //expect(instance).to.be.a(PlastiqPublicApi.PatchCard);
    });
    ...
    it('should have the property cardHolderName (base name: "cardHolderName")', function() {
      ...
      //var instance = new PlastiqPublicApi.PatchCard();
