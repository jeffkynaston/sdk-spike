...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.PaymentRefund();
  });
  ...
  describe('PaymentRefund', function() {
    it('should create an instance of PaymentRefund', function() {
      ...
      //var instane = new PlastiqPublicApi.PaymentRefund();
      //expect(instance).to.be.a(PlastiqPublicApi.PaymentRefund);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new PlastiqPublicApi.PaymentRefund();
