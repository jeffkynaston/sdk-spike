...
export default class PaymentMethodsApi {
    ...
    */
     ...
     */
    paymentMethodsGet(payerId, opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the paymentMethodsIdDelete operation.
     * @callback module:api/PaymentMethodsApi~paymentMethodsIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PaymentMethodsApi~paymentMethodsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    paymentMethodsIdDelete(id, callback) {
      let postBody = null;
     ...
     */
    paymentMethodsIdGet(payerId, id, callback) {
      let postBody = null;
      // verify the required parameter 'payerId' is set
      if (payerId === undefined || payerId === null) {
    ...
    /**
     * Callback function to receive the result of the paymentMethodsIdPatch operation.
     * @callback module:api/PaymentMethodsApi~paymentMethodsIdPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PaymentMethod} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PaymentMethodsApi~paymentMethodsIdPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PaymentMethod}
     */
    paymentMethodsIdPatch(id, patchPaymentMethodRequest, opts, callback) {
      opts = opts || {};
     ...
     * @callback module:api/PaymentMethodsApi~paymentMethodsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PaymentMethod} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.endUserDeviceId A unique identifier for the end user's browser. Recommended for compliance when the request is not coming from the end user's browser.
     * @param {String} opts.endUserIp The IP address of the end user. Recommended for compliance when the request is not coming from the end user's browser.
     * @param {module:api/PaymentMethodsApi~paymentMethodsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PaymentMethod}
     */
    paymentMethodsPost(createPaymentMethodRequest, opts, callback) {
      opts = opts || {};
