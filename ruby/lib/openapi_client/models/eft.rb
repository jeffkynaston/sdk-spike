  ...
  class EFT
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EFT` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EFT`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @routing_number.to_s.length > 8
        invalid_properties.push('invalid value for "routing_number", the character length must be smaller than or equal to 8.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["EFT"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["EFT"])
    ...
    def routing_number=(routing_number)
      ...
      if routing_number.to_s.length > 8
        fail ArgumentError, 'invalid value for "routing_number", the character length must be smaller than or equal to 8.'
      end
