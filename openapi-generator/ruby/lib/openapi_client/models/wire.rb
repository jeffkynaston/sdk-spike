  ...
  class Wire
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Wire` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Wire`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @account_number.to_s.length > 35
        invalid_properties.push('invalid value for "account_number", the character length must be smaller than or equal to 35.')
      end
      ...
      if @routing_number.to_s.length > 11
        invalid_properties.push('invalid value for "routing_number", the character length must be smaller than or equal to 11.')
      end

      if @routing_number.to_s.length < 8
        invalid_properties.push('invalid value for "routing_number", the character length must be great than or equal to 8.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["WIRE"])
      return false unless type_validator.valid?(@type)
      return false if @account_number.nil?
      return false if @account_number.to_s.length > 35
      return false if @account_number.to_s.length < 1
      return false if @routing_number.nil?
      return false if @routing_number.to_s.length > 11
      return false if @routing_number.to_s.length < 8
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["WIRE"])
    ...
    def account_number=(account_number)
      ...
      if account_number.to_s.length > 35
        fail ArgumentError, 'invalid value for "account_number", the character length must be smaller than or equal to 35.'
      end
    ...
    def routing_number=(routing_number)
      ...
      if routing_number.to_s.length > 11
        fail ArgumentError, 'invalid value for "routing_number", the character length must be smaller than or equal to 11.'
      end

      if routing_number.to_s.length < 8
        fail ArgumentError, 'invalid value for "routing_number", the character length must be great than or equal to 8.'
      end
    ...
    def hash
      [type, account_number, routing_number, beneficiary_name, country].hash
    end
