...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new PlastiqPublicApi.InlineObject();
      //expect(instance).to.be.a(PlastiqPublicApi.InlineObject);
    });

    it('should have the property payer (base name: "payer")', function() {
      // uncomment below and update the code to test the property payer
      //var instance = new PlastiqPublicApi.InlineObject();
