...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.PaymentIntent();
  });
  ...
  describe('PaymentIntent', function() {
    it('should create an instance of PaymentIntent', function() {
      ...
      //var instane = new PlastiqPublicApi.PaymentIntent();
      //expect(instance).to.be.a(PlastiqPublicApi.PaymentIntent);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new PlastiqPublicApi.PaymentIntent();
