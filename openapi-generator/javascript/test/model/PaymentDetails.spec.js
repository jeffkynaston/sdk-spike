...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.PaymentDetails();
  });
  ...
  describe('PaymentDetails', function() {
    it('should create an instance of PaymentDetails', function() {
      ...
      //var instane = new PlastiqPublicApi.PaymentDetails();
      //expect(instance).to.be.a(PlastiqPublicApi.PaymentDetails);
    });
    ...
    it('should have the property accountName (base name: "accountName")', function() {
      ...
      //var instance = new PlastiqPublicApi.PaymentDetails();
