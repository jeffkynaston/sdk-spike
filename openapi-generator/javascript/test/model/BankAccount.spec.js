...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.BankAccount();
  });
  ...
  describe('BankAccount', function() {
    it('should create an instance of BankAccount', function() {
      ...
      //var instane = new PlastiqPublicApi.BankAccount();
      //expect(instance).to.be.a(PlastiqPublicApi.BankAccount);
    });
    ...
    it('should have the property accountHolderName (base name: "accountHolderName")', function() {
      ...
      //var instance = new PlastiqPublicApi.BankAccount();
