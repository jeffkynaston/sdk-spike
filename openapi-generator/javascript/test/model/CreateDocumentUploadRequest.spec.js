...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.CreateDocumentUploadRequest();
  });
  ...
  describe('CreateDocumentUploadRequest', function() {
    it('should create an instance of CreateDocumentUploadRequest', function() {
      // uncomment below and update the code to test CreateDocumentUploadRequest
      //var instane = new PlastiqPublicApi.CreateDocumentUploadRequest();
      //expect(instance).to.be.a(PlastiqPublicApi.CreateDocumentUploadRequest);
    });

    it('should have the property payer (base name: "payer")', function() {
      // uncomment below and update the code to test the property payer
      //var instance = new PlastiqPublicApi.CreateDocumentUploadRequest();
