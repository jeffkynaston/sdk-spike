...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.InlineResponse200();
  });
  ...
  describe('InlineResponse200', function() {
    it('should create an instance of InlineResponse200', function() {
      ...
      //var instane = new PlastiqPublicApi.InlineResponse200();
      //expect(instance).to.be.a(PlastiqPublicApi.InlineResponse200);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new PlastiqPublicApi.InlineResponse200();
