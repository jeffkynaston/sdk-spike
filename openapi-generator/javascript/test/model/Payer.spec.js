...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.Payer();
  });
  ...
  describe('Payer', function() {
    it('should create an instance of Payer', function() {
      ...
      //var instane = new PlastiqPublicApi.Payer();
      //expect(instance).to.be.a(PlastiqPublicApi.Payer);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new PlastiqPublicApi.Payer();
