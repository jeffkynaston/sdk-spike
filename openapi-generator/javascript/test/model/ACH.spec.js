...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.ACH();
  });
  ...
  describe('ACH', function() {
    it('should create an instance of ACH', function() {
      // uncomment below and update the code to test ACH
      //var instane = new PlastiqPublicApi.ACH();
      //expect(instance).to.be.a(PlastiqPublicApi.ACH);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new PlastiqPublicApi.ACH();
