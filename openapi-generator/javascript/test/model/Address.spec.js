...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instane = new PlastiqPublicApi.Address();
      //expect(instance).to.be.a(PlastiqPublicApi.Address);
    });

    it('should have the property line1 (base name: "line1")', function() {
      // uncomment below and update the code to test the property line1
      //var instance = new PlastiqPublicApi.Address();
