...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.CreatePaymentRequest();
  });
  ...
  describe('CreatePaymentRequest', function() {
    it('should create an instance of CreatePaymentRequest', function() {
      ...
      //var instane = new PlastiqPublicApi.CreatePaymentRequest();
      //expect(instance).to.be.a(PlastiqPublicApi.CreatePaymentRequest);
    });
    ...
    it('should have the property paymentIntent (base name: "paymentIntent")', function() {
      ...
      //var instance = new PlastiqPublicApi.CreatePaymentRequest();
