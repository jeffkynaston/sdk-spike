 ...
 * @version 1.0.0
 */
class OneOfpayerIdCreatePayerRequest {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            if(data['id'] !== undefined)
                return PayerId.constructFromObject(data, obj);
            else
                return CreatePayerRequest.constructFromObject(data, obj);
        }
        return obj;
    }
}

export default OneOfpayerIdCreatePayerRequest;
