...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.InlineResponse2004();
  });
  ...
  describe('InlineResponse2004', function() {
    it('should create an instance of InlineResponse2004', function() {
      ...
      //var instane = new PlastiqPublicApi.InlineResponse2004();
      //expect(instance).to.be.a(PlastiqPublicApi.InlineResponse2004);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new PlastiqPublicApi.InlineResponse2004();
