...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.Contact();
  });
  ...
  describe('Contact', function() {
    it('should create an instance of Contact', function() {
      ...
      //var instane = new PlastiqPublicApi.Contact();
      //expect(instance).to.be.a(PlastiqPublicApi.Contact);
    });

    it('should have the property firstName (base name: "firstName")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new PlastiqPublicApi.Contact();
