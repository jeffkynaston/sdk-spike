...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new PlastiqPublicApi.InlineResponse2003();
      //expect(instance).to.be.a(PlastiqPublicApi.InlineResponse2003);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new PlastiqPublicApi.InlineResponse2003();
