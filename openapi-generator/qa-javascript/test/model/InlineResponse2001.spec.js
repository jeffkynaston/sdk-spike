...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new PlastiqPublicApi.InlineResponse2001();
      //expect(instance).to.be.a(PlastiqPublicApi.InlineResponse2001);
    });
    ...
    it('should have the property clientSecret (base name: "clientSecret")', function() {
      ...
      //var instance = new PlastiqPublicApi.InlineResponse2001();
