...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.CreateRecipientRequest();
  });
  ...
  describe('CreateRecipientRequest', function() {
    it('should create an instance of CreateRecipientRequest', function() {
      // uncomment below and update the code to test CreateRecipientRequest
      //var instane = new PlastiqPublicApi.CreateRecipientRequest();
      //expect(instance).to.be.a(PlastiqPublicApi.CreateRecipientRequest);
    });
    ...
    it('should have the property businessName (base name: "businessName")', function() {
      ...
      //var instance = new PlastiqPublicApi.CreateRecipientRequest();
