...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlastiqPublicApi.Card();
  });
  ...
  describe('Card', function() {
    it('should create an instance of Card', function() {
      ...
      //var instane = new PlastiqPublicApi.Card();
      //expect(instance).to.be.a(PlastiqPublicApi.Card);
    });
    ...
    it('should have the property cardHolderName (base name: "cardHolderName")', function() {
      ...
      //var instance = new PlastiqPublicApi.Card();
