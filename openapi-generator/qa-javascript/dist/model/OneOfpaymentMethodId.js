 ...
 * @version 1.0.0
 */
var OneOfpaymentMethodId = /*#__PURE__*/function () {
  function OneOfpaymentMethodId() {
    _classCallCheck(this, OneOfpaymentMethodId);
  }

  _createClass(OneOfpaymentMethodId, null, [{
    ...
    function constructFromObject(data, obj) {
      if (data) {
        return _PaymentMethodId["default"].constructFromObject(data, obj);
      }
  ...
  return OneOfpaymentMethodId;
}();

var _default = OneOfpaymentMethodId;
