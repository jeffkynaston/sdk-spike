...
var _ErrorErrors = _interopRequireDefault(require("./ErrorErrors"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('errors')) {
          obj['errors'] = _ApiClient["default"].convertToType(data['errors'], [_ErrorErrors["default"]]);
        }
...
Error.prototype['traceId'] = undefined;
var _default = Error;
