...
apiInstance.paymentMethodsGet(payerId, opts).then((data) => {
...
apiInstance.paymentMethodsIdDelete(id).then(() => {
...
let id = null; // String | The ID of the Payment Method
apiInstance.paymentMethodsIdGet(payerId, id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.paymentMethodsIdPatch(id, patchPaymentMethodRequest, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.paymentMethodsPost(createPaymentMethodRequest, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
